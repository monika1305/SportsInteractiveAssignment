 ...
 */
public class TeamTwoTabFragment extends Fragment {
    ...
    public static TeamTwoTabFragment newInstance(TeamsEntity birthdayPojos) {
        TeamTwoTabFragment fragment = new TeamTwoTabFragment();
...
//                Log.d("TeamOneTabFragment", "TeamOneTabFragment playersEntities size ::::" + (playersEntities.size()));
    ...
    class CustomTabsAdapter extends RecyclerView.Adapter<CustomTabsAdapter.MyViewHolder> {
        ...
        public CustomTabsAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new CustomTabsAdapter.MyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.players_list_items, viewGroup, false));
        }

        @Override
        public void onBindViewHolder(CustomTabsAdapter.MyViewHolder myViewHolder, int i) {
